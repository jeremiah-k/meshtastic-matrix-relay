...
class BaseRadioBackend(ABC):
    ...
    def backend_name(self) -> str:
        """Unique identifier for this radio backend (e.g., 'meshtastic', 'alternative_backend')"""
        pass

    @property
    @abstractmethod
    def backend_prefix(self) -> str:
        """Default message prefix for this backend (e.g., '[MT]', '[AB]')"""
        pass
...
class RadioMessage:
    ...
    # Backend identification
    backend: str  # e.g., 'meshtastic', 'alternative_backend'
    meshnet_name: str
