...
class TestConfigChecker(unittest.TestCase):
    ...
    def test_check_config_missing_matrix_section_with_credentials(
        ...
        This simulates the scenario where the user has commented out the matrix section
        but has valid credentials.json file.
        """
        args = MagicMock()
        args.config = None
        ...
        mock_validate_yaml.return_value = (True, None, config_with_minimal_matrix)
    ...
    def test_check_config_missing_matrix_section_with_credentials_fails(
        ...
        but has valid credentials.json file. Should fail and provide helpful guidance.
        """
        args = MagicMock()
        args.config = None
        mock_parse_args.return_value = args

        # Config with no matrix section at all
