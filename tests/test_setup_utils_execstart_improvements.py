...
class TestExecStartImprovements(unittest.TestCase):
    ...
    def test_quote_if_needed_with_spaces(self) -> None:
    ...
    def test_quote_if_needed_without_spaces(self) -> None:
    ...
    @patch("shutil.which")
    def test_get_resolved_exec_cmd_found(self, mock_which) -> None:
    ...
    def test_get_resolved_exec_cmd_not_found(self, mock_which) -> None:
    ...
    def test_get_resolved_exec_cmd_with_spaces_in_python(self, mock_which) -> None:
    ...
    def test_get_resolved_exec_start_default_args(self, mock_get_cmd) -> None:
    ...
    @patch("mmrelay.setup_utils.get_resolved_exec_cmd")
    def test_get_resolved_exec_start_custom_args(self, mock_get_cmd) -> None:
