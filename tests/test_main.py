...
class _TaskSpy:
    ...
    def __init__(task: asyncio.Task[Any]) -> None:
        self._task = task
...
class _ControlledExecutor:
    ...
    def shutdown(wait: bool = False, cancel_futures: bool = False) -> None:
        """
...
# =============================================================================
# TestMain (converted from unittest.TestCase)
# =============================================================================
...
def test_main_with_message_map_wipe(mock_config):
    """
    ...
    config_with_wipe = mock_config.copy()
...
def test_main_matrix_connection_failure(
    ...
    with (
        ...
        with pytest.raises(Exception) as exc_info:
            asyncio.run(main(mock_config))
    assert "Matrix connection failed" in str(context.exception)
...
# =============================================================================
# TestPrintBanner (converted from unittest.TestCase)
# =============================================================================
...
# =============================================================================
# TestRunMain (converted from unittest.TestCase)
# =============================================================================
...
# =============================================================================
# TestMainFunctionEdgeCases (converted from unittest.TestCase)
# =============================================================================


def test_main_with_database_wipe_new_format(mock_config):
    """
...
def test_main_with_database_wipe_legacy_format(mock_config):
    """
...
def test_main_with_custom_message_delay(mock_config):
    """
    ...
    config_with_delay = mock_config.copy()
...
def test_nodedb_refresh_interval_invalid_defaults():
    ...
    for raw_value in ("inf", "not-a-number", True, False, -1.0):
        with subTest(raw_value=raw_value):
...
def test_shutdown_exceptions_are_logged_and_suppressed():
    ...
    for exception_class in (KeyboardInterrupt, SystemExit):
        with subTest(exception_class=exception_class):
            try:
                config = {
                    "matrix_rooms": [{"id": TEST_ROOM_ID_1}],
                    "matrix": {"homeserver": TEST_MATRIX_HOMESERVER},
...
def test_exception_during_ensure_processor_started_raised():
    ...
    with (
        ...
        assert "Queue processor failed" in str(context.exception)
