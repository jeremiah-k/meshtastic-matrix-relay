...
class TestCLIEdgeCases(unittest.TestCase):
    ...
    def test_check_config_radio_backend_disabled_without_meshtastic_channel(self):
        """
        Test that check_config returns True when radio_backend is disabled and rooms lack meshtastic_channel.
        """
        config = {
            "matrix": {
                "homeserver": "https://matrix.org",
    ...
    def test_check_config_boolean_false_radio_backend(self):
        """
        Test that check_config returns True when radio_backend is boolean False.
        """
        config = {
            "matrix": {
                "homeserver": "https://matrix.org",
