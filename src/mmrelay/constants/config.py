...
CONFIG_KEY_POOL_MAX_CONNECTIONS = "pool_max_connections"
CONFIG_KEY_POOL_MAX_IDLE_TIME = "pool_max_idle_time"
CONFIG_KEY_POOL_TIMEOUT = "pool_timeout"
CONFIG_KEY_POOL_ENABLED = "pool_enabled"
...
DEFAULT_POOL_MAX_IDLE_TIME = 300
